...
persona_parser.add_argument("nombre", type=str, required=True, help="Nombre es requerido.")
persona_parser.add_argument("apellido", type=str, required=True, help="Apellido es requerido.")
persona_parser.add_argument("email", type=str, required=True, help="Email es requerido.")
#persona_parser.add_argument("birthdate", type=str, required=True, help="Fecha de nacimiento es requerida.")
persona_parser.add_argument("personal_id", type=str, required=True, help="ID personal es requerido.")
persona_parser.add_argument("genero_id", type=int, required=True, help="ID de género es requerido.")
